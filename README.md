...
* **Purpose:** Demonstrate and deliver AI features by combining all AI Building Blocks into a unified WordPress experience.
...
1. **Showcase integration** – Demonstrate how all Building Blocks work together.
2. **User-focused** – Deliver practical AI features users can use today.
