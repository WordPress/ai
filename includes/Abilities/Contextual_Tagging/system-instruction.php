...
Goal: Analyze the provided content (wrapped in <content> tags, with any additional context in <existing-terms> and <strategy> tags) and suggest up to {$max_suggestions} relevant terms for the {$taxonomy_name} taxonomy.
