...
/**
 * Upgrade routine for standardizing post meta keys on the `wpai_` prefix.
 *
 * Renames the legacy `ai_generated` and `ai_generated_summary` post meta keys to
 * their `wpai_`-prefixed equivalents so all plugin-owned meta shares a consistent
 * namespace.
 *
 * @since 1.2.0
 * @internal
...
class V1_2_0 extends Abstract_Upgrade {
	 ...
	 * {@inheritDoc}
	 *
	 * Migrates post meta keys from the legacy `ai_` prefix to the `wpai_` prefix.
	 *
	 * @since 1.2.0
	 */
