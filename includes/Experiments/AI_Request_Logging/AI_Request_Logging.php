...
class AI_Request_Logging extends Abstract_Experiment {
	 ...
	 */
	private const OPTION_RETENTION_DAYS = 'ai_experiment_ai_request_logging_retention_days';
	...
	public function register(): void {
		// Always set up table creation and cleanup scheduling.
		...
		// Register the admin page (always visible so users can see logs even when disabled).
	...
	/**
	 * Registers REST API routes for log management.
	 */
	public function register_rest_routes(): void {
		$controller = new REST\AI_Request_Log_Controller( $this );
		...
		Asset_Loader::localize_script(
			...
			array(
				...
				'initialState' => array(
					...
					'retentionDays' => $this->get_retention_days(),
					'summary'       => $this->get_summary( 'day' ),
	...
	public function render_settings_fields(): void {
		...
		<div class="ai-experiment-settings">
			<label for="<?php echo esc_attr( self::OPTION_RETENTION_DAYS ); ?>" class="ai-experiment-settings__label">
			...
			<input
				...
				max="365"
				step="1"
				id="<?php echo esc_attr( self::OPTION_RETENTION_DAYS ); ?>"
				name="<?php echo esc_attr( self::OPTION_RETENTION_DAYS ); ?>"
	...
	/**
	 * Sanitizes the retention days setting.
	 *
