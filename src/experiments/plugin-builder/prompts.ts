...
- IMPORTANT: Plugin slugs MUST start with \`apb-\` prefix (AI Plugin Builder). For example: \`apb-maintenance-mode\`, \`apb-contact-form\`, \`apb-gallery\`. This ensures uniqueness and avoids conflicts with existing WordPress.org plugins.
