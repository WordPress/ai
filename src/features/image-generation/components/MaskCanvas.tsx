 ...
 */
export const MaskCanvas = forwardRef< MaskCanvasHandle, Props >( function (
	{ imageSrc, brushSize, onMaskChange },
	ref
) {
	...
	useEffect( () => {
		...
		ctxRef.current.clearRect( 0, 0, naturalSize.width, naturalSize.height );
