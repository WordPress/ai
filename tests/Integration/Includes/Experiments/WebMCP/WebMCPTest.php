...
class WebMCPTest extends WP_UnitTestCase {
	...
	public function test_settings_page_disables_toggle_when_unavailable() {
		...
		// Mirror core admin globals expected by get_admin_page_title() in test context.
		$GLOBALS['plugin_page'] = 'ai-experiments'; // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited -- Test fixture setup for core admin state.
